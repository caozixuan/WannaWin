...
-- Schema huaqi
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `huaqi` DEFAULT CHARACTER SET utf8 ;
USE `huaqi` ;
...
CREATE TABLE IF NOT EXISTS `huaqi`.`cardtype` (
  ...
  `Proportion` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `huaqi`.`user` (
  ...
  `MinimalExpense` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`UserID`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
