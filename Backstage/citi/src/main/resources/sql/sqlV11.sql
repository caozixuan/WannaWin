...
CREATE TABLE IF NOT EXISTS `huaqi`.`merchant` (
  ...
  `businessType` VARCHAR(64) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `huaqi`.`activity`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `huaqi`.`activity` (
  ...
  INDEX `merchnatID_activity_FK_idx` (`merchantID` ASC),
  CONSTRAINT `merchnatID_activity_FK`
    FOREIGN KEY (`merchantID`)
    REFERENCES `huaqi`.`merchant` (`MerchantID`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
CREATE TABLE IF NOT EXISTS `huaqi`.`points_history` (
  ...
  INDEX `merchantID_FK_points_history_idx` (`merchantID` ASC),
  CONSTRAINT `merchantID_FK_points_history`
    FOREIGN KEY (`merchantID`)
    REFERENCES `huaqi`.`merchant` (`MerchantID`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `huaqi`.`userPref`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `huaqi`.`userPref` (
  `userID` VARCHAR(45) NOT NULL,
  `prefType` CHAR(128) NOT NULL,
  PRIMARY KEY (`userID`),
...
-- -----------------------------------------------------
-- Table `huaqi`.`visitRecord`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `huaqi`.`visitRecord` (
  `userID` VARCHAR(45) NOT NULL,
  `itemID` VARCHAR(45) NOT NULL,
  `time` TIMESTAMP NULL DEFAULT NULL,
