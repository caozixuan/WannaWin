...
public interface UserMapper {
    ...
    final String loginVerify = "SELECT userID, phoneNum, generalPoints, availablePoints, citiCard FROM user WHERE phoneNum = #{phoneNum} AND password = #{password}";
    ...
    @Results(
            value = {
                    ...
                    @Result(property = "citiCardNum", column = "citiCard")
            }
    )
