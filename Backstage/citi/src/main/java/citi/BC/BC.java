...
//            // 发送POST请求必须设置如下两行
    ...
    public static void test(String[] args) {
        ...
        if (secondBlock.data.merchantID == "1") {
            System.out.println("\nThe 2nd block chain decoded by Merchant-1: ");
        ...
        if (secondBlock.data.merchantID == "2") {
            System.out.println("\nThe 2nd block chain decoded by Merchant-2: ");
            System.out.println("Type, userID, points");
        ...
        if (thirdBlock.data.merchantID == "1") {
            System.out.println("The 3rd block chain decoded by Merchant-1: ");
            System.out.println("Type, userID, points\n");
        ...
        if (thirdBlock.data.merchantID == "2") {
            System.out.println("\nThe 3rd block chain decoded by Merchant-2: ");
            System.out.println("Type, userID, points");
